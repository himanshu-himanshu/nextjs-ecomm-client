...
const Footer = () => {
  return (
    <footer className="p-4 bg-white shadow md:px-6 md:py-8 dark:bg-gray-900">
      ...
      <span className="block text-md tracking-wider text-gray-500 sm:text-center dark:text-gray-400 font-Gruppo font-extrabold">
        <a href="https://flowbite.com/" className="hover:underline">
          GRAB.IT
        </a>{" "}
        © 2024 . All Rights Reserved.
      </span>
      <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-40 my-6 font-Gruppo">
