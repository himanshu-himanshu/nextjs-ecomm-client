  ...
  return (
    <>
      <motion.div
        ...
        className="bg-gray-800 absolute w-full h-full top-0 left-0 overflow-hidden cursor-crosshair"
      ...
      <motion.div
        ...
        className="absolute h-full bg-white top-0 right-0 w-full sm:min-w-[500px] sm:w-1/3 z-10 overflow-hidden"
      >
